        ...
        try {
            ...
            if (count($perguntasTexto) > 0) {
                foreach ($perguntasTexto as $pergunta) {
                    ...
                    echo "<td class='actions'>";
                    echo "<a href='alterarPerguntaMultipla.php?numero_pergunta={$pergunta['numero_pergunta']}' class='btn-edit'>Editar</a>";
                    echo "<a href='alterarPerguntaTexto.php?numero_pergunta={$pergunta['numero_pergunta']}' class='btn-edit'>Editar</a>";
